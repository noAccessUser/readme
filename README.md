...
- [Описание API](#описание-api)
	...
	- [Objective-C интерфейс](#objective-sc-интерфейс)
- [Лицензия](#лицензия)
...
Модели, созданные другими фреймворками, могут быть использованы в NeoML благодаря поддержке формата [ONNX](https://onnx.ai/).
